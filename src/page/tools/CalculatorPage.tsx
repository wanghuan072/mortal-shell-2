...
export default function CalculatorPage() {
  ...
  return <div className={`container ${styles.page}`}>
    <JsonLd data={{ "@context": "https://schema.org", "@type": "WebApplication", name: "Mortal Shell II Damage and Stagger Calculator", url: canonical, applicationCategory: "GameApplication", description: "Mortal Shell II damage calculator: weapon damage, stagger, and crit values by Forge level." }} />
    <Breadcrumbs items={[{ label: "Tools", href: "/tools/" }, { label: "Damage & Stagger Calculator" }]} />
    <section className={styles.hero}><Image alt="A Shell swinging a battle axe in close combat" fill priority sizes="100vw" src="/images/official/gallery/combat-axe.jpg" /><span className={styles.shade} /><div className={styles.heroInner}><p>Tools / Weapon math</p><h1>Mortal Shell II Damage &amp; Stagger Calculator</h1><div>Choose a weapon and Forge level, enter a base value, and see how the listed level multiplier changes damage, stagger, and critical output.</div></div></section>
    <DamageCalculator />
