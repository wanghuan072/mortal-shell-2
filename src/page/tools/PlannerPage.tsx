...
export default function PlannerPage() {
  ...
  return <div className={`container ${styles.page}`}>
    <JsonLd data={{ "@context": "https://schema.org", "@type": "WebApplication", name: "Mortal Shell II Build Planner", url: canonical, applicationCategory: "GameApplication", description: "Assemble and share a Mortal Shell II Shell, weapon, sidearm, seal, and Tarstone loadout." }} />
