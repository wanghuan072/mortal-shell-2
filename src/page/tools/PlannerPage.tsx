...
export default function PlannerPage() {
  ...
  return <div className={`container ${styles.page}`}>
    ...
    <section className={styles.hero}><Image alt="A Shell facing a swamp creature with a glowing greatsword" fill priority sizes="100vw" src="/images/official/gallery/official-combat.jpg" /><span className={styles.shade} /><div className={styles.heroInner}><p>Tools / Build planning</p><h1>Mortal Shell II Build Planner</h1><div>Assemble a full loadout, set the primary weapon level, and copy a link that rebuilds the exact setup.</div></div></section>
    <BuildPlanner />
    <p className={styles.note}>Planner options use 1.0 launch records. A planned loadout is a snapshot of the current pages, not a ranked build list.</p>
  </div>;
}
